...
def main(config):
    ...
    model, tokenizer = load_model(config['model_name'], num_layers=config['num_layers'],
                                  hidden_size=config['hidden_size'], model_path=f"{config['model_name']}.pt")

    # Set up the optimizer and loss function
    optimizer = create_optimizer(config['optimizer_name'], config['learning_rate'], model.parameters())
